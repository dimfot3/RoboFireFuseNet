...
- Download the [weights](https://drive.google.com/drive/folders/1wPnB64vP4Rq5YgwhpJB2uRk4oLHN0Dpz?usp=drive_link) inside the weights folder.
- Download the preprocessed [data](https://drive.google.com/drive/folders/1Q_Cbe8rEBon8s5UkDqSDaZgx37Js1zEv?usp=sharing) inside the data folder. We include our annotations on subset of public FLAME2 dataset <sup>[[2]](#2)</sup> (see Licensing for details), preprocessed MFNet dataset <sup>[[3]](#3)</sup>.
